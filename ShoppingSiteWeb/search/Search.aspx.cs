...
namespace ShoppingSiteWeb.search
{
    ...
    public partial class Search : System.Web.UI.Page
    {
        ...
        {
            //查詢關鍵字為空
            if(Context.Request.QueryString["commoditySearch"] == null)
            {
        ...
        private void selectRecommendCommoditys()
        {
            ...
            DB.connectionReader(
                ...
                new ArrayList {
                    new DB.Parameter("CommoditySearch", SqlDbType.NVarChar, $"%{Context.Request.QueryString["commoditySearch"]}%")
                },
                (SqlDataReader ts) => {
                    gv.DataSource = ts;
                    gv.DataBind();
            ...
            //搜索到的商品
            searchNum.Text = $"搜索到 {((ArrayList)ViewState["CommodityList"]).Count} 樣商品";
        }
        ...
        private void showCommodityPage()
        {
            ...
            /// 商品列數量
            /// </summary>
            int column = (CommodityList.Count/6)+1;
            /// <summary>
            /// 商品頁(框架)
            /// </summary>
